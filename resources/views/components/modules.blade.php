...
'icon' => '<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" stroke="currentColor">
    <path d="M12 20h9" />
...
$tracks = collect($courses)->take(8)->map(function ($course) use ($trackStyles, $defaultStyle) {
