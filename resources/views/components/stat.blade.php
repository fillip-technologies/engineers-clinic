<section class="relative py-24"
    ...
    <div class="absolute inset-0 pointer-events-none">
        <div class="absolute bottom-0 right-0 w-[420px] h-[420px] rounded-full blur-[160px] opacity-60 bg-glowPink"></div>
        <div class="absolute top-0 left-0 w-[420px] h-[420px] rounded-full blur-[160px] opacity-60 bg-glowPurple"></div>
    </div>

    <div class="relative max-w-5xl mx-auto px-6">

        <!-- CARD -->
        <div class="backdrop-blur rounded-3xl shadow-lg px-12 py-14
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 text-center">
                ...
                <div class="flex flex-col items-center px-6 py-6">
                    <p class="text-4xl md:text-5xl font-bold text-textPrimary counter"
